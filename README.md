...
- **Blue Line**: Local reference path generated by the DNN model, which the vehicle attempts to follow (trajectory in world coordinate system used as input for Model Predictive Control).
